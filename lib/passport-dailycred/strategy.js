...
function Strategy(options, verify) {
  ...
  options.tokenURL = options.tokenURL || 'https://www.dailycred.com/oauth/api/token.json';
...
Strategy.prototype.userProfile = function(accessToken, done) {
  this._oauth2.getProtectedResource('https://www.dailycred.com/oauth/api/me.json', accessToken, function (err, body, res) {
