...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'http://localhost:9000/oauth/authorize';
  options.tokenURL = options.tokenURL || 'http://localhost:9000/oauth/tokeninfo';
...
Strategy.prototype.userProfile = function(accessToken, done) {
  this._oauth2.getProtectedResource('http://localhost:9000/oauth/me', accessToken, function (err, body, res) {
    ...
    try {
      ...
      profile.clientId = json.clientId;
      profile._raw = body;
      profile._json = json;
